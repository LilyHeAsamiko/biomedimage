...
model_estimation.matlabbatch{2}.spm.stats.fmri_est.spmmat = {[stats_dir filesep 'SPM_f.mat']};
% write_residuals
model_estimation.matlabbatch{2}.spm.stats.fmri_est.write_residuals = 0;
% method
model_estimation.matlabbatch{2}.spm.stats.fmri_est.method.Classical = 1;
% RUN BATCH JOB
